  ...
  return (
    <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-[#a8dadc] mb-6 drop-shadow-lg">
          The Salty Vibe
        </h1>
        <p className="font-display text-xl md:text-2xl text-[#a8dadc]/90 mb-8 max-w-2xl mx-auto leading-relaxed">
