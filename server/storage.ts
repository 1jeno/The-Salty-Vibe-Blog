...
export class MemStorage implements IStorage {
  ...
  private initializeSampleAffiliateProducts(): void {
    const sampleProducts = [
      ...
      {
        id: "gm-collin-marine-collagen-cream",
        name: "G.M. Collin Marine Collagen Cream",
        description: "Professional-grade marine collagen technology for deep hydration and skin recovery. Perfect for sun-exposed skin that needs intensive nourishment.",
        category: "beauty",
        price: "89.00",
        imageUrl: "/images/Amazon_G.M.Collin.jpeg",
        affiliateUrl: "https://amzn.to/46y0Zic",
        retailer: "Amazon",
        isActive: true,
        clickCount: "0",
        createdAt: new Date(),
      ...
      {
        id: "gm-collin-vitamin-c-serum",
        name: "G.M. Collin Vitamin C Serum",
        description: "Powerful yet gentle vitamin C serum for brightening and evening skin tone. Professional-grade formula perfect for daily use in coastal environments.",
        category: "beauty",
        price: "72.00",
        imageUrl: "/images/Amazon_G.M.Collin.jpeg",
        affiliateUrl: "https://amzn.to/4gE5Hzz",
        retailer: "Amazon",
        isActive: true,
        clickCount: "0",
        createdAt: new Date(),
      ...
      {
        id: "gm-collin-daily-spf",
        name: "G.M. Collin Daily Sun Protection SPF 30",
        description: "Lightweight, non-greasy daily sunscreen perfect for coastal living. Clean formula provides effective protection without heavy feel.",
        category: "beauty",
        price: "45.00",
        imageUrl: "/images/Amazon_G.M.Collin.jpeg",
        affiliateUrl: "https://www.gmcollin.com/collections/sun-protection",
        retailer: "G.M. Collin",
        isActive: true,
        clickCount: "0",
        createdAt: new Date(),
